...
var identity = __webpack_require__(40),
    metaMap = __webpack_require__(78);
...
var composeArgs = __webpack_require__(61),
    ...
    reorder = __webpack_require__(202),
...
var isLaziable = __webpack_require__(184),
    ...
    setWrapToString = __webpack_require__(83);
...
var metaMap = __webpack_require__(78),
...
var WeakMap = __webpack_require__(48);
...
var getWrapDetails = __webpack_require__(170),
    insertWrapDetails = __webpack_require__(180),
...
var asciiToArray = __webpack_require__(114),
...
var createWrap = __webpack_require__(162);
...
var baseClamp = __webpack_require__(117),
...
var arrayReduce = __webpack_require__(30),
    ...
    baseIteratee = __webpack_require__(57),
    baseReduce = __webpack_require__(137),
    isArray = __webpack_require__(1);
...
var _split = __webpack_require__(101);
...
var _endsWith = __webpack_require__(94);

var _endsWith2 = _interopRequireDefault(_endsWith);

var _isEqual = __webpack_require__(97);
...
var _trim = __webpack_require__(102);

var _trim2 = _interopRequireDefault(_trim);

var _findIndex = __webpack_require__(95);

var _findIndex2 = _interopRequireDefault(_findIndex);

var _concat = __webpack_require__(92);
...
var _curry = __webpack_require__(93);

var _curry2 = _interopRequireDefault(_curry);

var _cloneDeep = __webpack_require__(91);
...
var detectArrayOfObject = exports.detectArrayOfObject = function detectArrayOfObject(pathElement) {
  return (0, _includes2.default)(pathElement, '[{') && (0, _endsWith2.default)(pathElement, '}]');
};

var parsePathElement = exports.parsePathElement = function parsePathElement(pathElement) {
  if (detectArrayOfObject(pathElement)) {
    var elements = (0, _split2.default)(pathElement, '[{');
    var objectString = (0, _trim2.default)(elements[1], '[{}]');
    var key = elements[0];
    var selector = (0, _split2.default)(objectString, '=')[0];
    var value = (0, _split2.default)(objectString, '=')[1];
    return {
      key: key,
      selector: selector,
      value: value
...
var getFromPath = function getFromPath(origin, path) {
  ...
  return (0, _get2.default)(origin, path);
};
...
var normalizePath = exports.normalizePath = function normalizePath(origin) {
  ...
  var pathElements = (0, _split2.default)(path, magicRegex);
  var newValue = (0, _reduce2.default)(pathElements, function (result, pathElement) {
    if (detectArrayOfObject(pathElement)) {
      ...
      var newPathArray = key ? (0, _concat2.default)(result, key) : result;
      var newPath = (0, _join2.default)(newPathArray, '.');
      var valueFromKey = getFromPath(origin, newPath);
      var newIndex = (0, _findIndex2.default)(valueFromKey, function (objectInArray) {
        return (0, _isEqual2.default)((0, _toString2.default)((0, _get2.default)(objectInArray, selector)), value);
      });

      return (0, _concat2.default)(result, key + '[' + newIndex + ']');
    }
    return (0, _concat2.default)(result, pathElement);
  }, []);
  return (0, _join2.default)(newValue, '.');
};
...
var getDeepPath = exports.getDeepPath = (0, _curry2.default)(getDeepPathFunction);
...
var normalizedGetFunction = exports.normalizedGetFunction = function normalizedGetFunction(path, origin) {
  ...
  return (0, _get2.default)(origin, normalizedPath);
};
var deepGet = exports.deepGet = (0, _curry2.default)(normalizedGetFunction);

// NormalizeSet
var normalizedSetFunction = exports.normalizedSetFunction = function normalizedSetFunction(path, data, origin) {
  var normalizedPath = normalizePath(origin, path);
  var newOrigin = (0, _cloneDeep2.default)(origin);
  (0, _set2.default)(newOrigin, normalizedPath, data);
  return newOrigin;
};
var deepSet = exports.deepSet = (0, _curry2.default)(normalizedSetFunction);
...
var normalizedUpdateFunction = exports.normalizedUpdateFunction = function normalizedUpdateFunction(path, updateFunction, origin) {
  var normalizedPath = normalizePath(origin, path);
  var newOrigin = (0, _cloneDeep2.default)(origin);
  var oldData = (0, _get2.default)(origin, normalizedPath);
  var newData = updateFunction(oldData);
  (0, _set2.default)(newOrigin, normalizedPath, newData);
  return newOrigin;
};
var deepUpdate = exports.deepUpdate = (0, _curry2.default)(normalizedUpdateFunction);
...
var apply = __webpack_require__(49),
    createCtor = __webpack_require__(20),
    createHybrid = __webpack_require__(63),
    createRecurry = __webpack_require__(64),
    getHolder = __webpack_require__(70),
    replaceHolders = __webpack_require__(39),
    root = __webpack_require__(0);
...
var realNames = __webpack_require__(201);
...
var baseIsRegExp = __webpack_require__(129),
    baseUnary = __webpack_require__(59),
    nodeUtil = __webpack_require__(79);
